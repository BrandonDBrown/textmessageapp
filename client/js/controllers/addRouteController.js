...
textMessageApp.controller('AddRouteController', [ '$scope', 'Account', '$http', '_', 'moment', '$routeParams', '$location', 'Route', function($scope, Account, $http, _, moment, $routeParams, $location, Route) {
